...
DROP POLICY IF EXISTS "Public can view unexpired tokens" ON public.howbody_public_report_tokens;
DROP POLICY IF EXISTS "howbody_public_report_tokens_no_authenticated_read_policy" ON public.howbody_public_report_tokens;
