CREATE OR REPLACE FUNCTION public.record_delivery_event(p_log_id uuid, p_new_status text, p_provider text DEFAULT NULL::text, p_provider_message_id text DEFAULT NULL::text, p_error text DEFAULT NULL::text, p_metadata jsonb DEFAULT '{}'::jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
