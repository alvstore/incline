  ...
  return (
    <main className="min-h-screen bg-muted flex items-center justify-center px-4 py-12">
        <SEO
          ...
          path="/data-deletion"
        />
        <Card className="w-full max-w-xl rounded-2xl shadow-lg shadow/60 border-0">
          <CardHeader>
            ...
            {confirmation ? (
              <div className="text-center py-8 space-y-3">
                ...
                <div className="text-xs text-muted-foreground mt-4">
                  Confirmation code:{" "}
                  <code className="bg-muted px-2 py-1 rounded font-mono">{confirmation}</code>
                </div>
              </div>
            ) : (
              <form onSubmit={submit} className="space-y-4">
                ...
                <p className="text-xs text-muted-foreground text-center">
                  Questions? Email{" "}
                  <a href="mailto:privacy@theinclinelife.com" className="text-primary font-medium">
