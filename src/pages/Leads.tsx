    ...
    <AppLayout>
      <div className="space-y-5">
        ...
        {staleCount > 0 && viewMode !== 'analytics' && (
          <div className="rounded-2xl bg-warning/10 border border-warning/25 px-4 py-3 flex items-center justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              <div className="h-9 w-9 shrink-0 rounded-full bg-warning/15 text-warning flex items-center justify-center">
