...
export interface MenuItem {
  ...
  roles: AppRole[];
  /** Extra runtime gate. 'has_pt_package' → only show to members with a PT package. */
  requires?: 'has_pt_package';
}
...
export const memberMenuConfig: MenuSection[] = [
  ...
  },
  {
    title: 'Fitness',
    items: [
      { label: 'Book & Schedule', href: '/book', icon: Calendar, roles: ['member'] },
      { label: 'PT Sessions', href: '/my-pt-sessions', icon: Dumbbell, roles: ['member'], requires: 'has_pt_package' },
...
export const trainerMenuConfig: MenuSection[] = [
  ...
  },
  {
    title: 'Services',
    items: [
      { label: 'Member Store', href: '/member-store', icon: ShoppingBag, roles: ['trainer'] },
  ...
  },
  {
    title: 'Work',
    items: [
      { label: 'Tasks', href: '/tasks', icon: CheckSquare, roles: ['trainer'] },
      { label: 'My Attendance', href: '/my-attendance', icon: Clock, roles: ['trainer'] },
      { label: 'Announcements', href: '/member-announcements', icon: Megaphone, roles: ['trainer'] },
    ],
  },
  {
    title: 'Account',
